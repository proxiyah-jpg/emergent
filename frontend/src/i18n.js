...
export const translations = {
  fr: {
    ...
    manifesto: {
      ...
      chapters: [
        ...
        { num: "02", title: "Pour Qui", text: "Joueurs et joueuses de U17 à U23. Déjà en club ? Parfait. Nos entraînements complémentaires s'ajoutent à votre programme pour accélérer votre progression et booster votre carrière." },
    ...
    coaches: {
      ...
      title1: "Des coachs,",
      title2: "un parcours éprouvé.",
      imageLabel: "Séance dirigée par notre staff",
      list: [
        { initials: "YJ", name: "Y. Janssens", role: "Entraîneur Principal", text: "Plus de 15 ans d'expérience dans la formation de jeunes. Ex-coach en académie professionnelle belge, spécialiste du développement technique U17-U23." },
        { initials: "KD", name: "K. De Smet", role: "Préparateur Physique", text: "Diplômé en sciences du sport, il construit des athlètes complets : vitesse, explosivité, endurance et prévention des blessures." },
        { initials: "MD", name: "M. Dupont", role: "Entraîneur des Gardiens", text: "Ancien gardien de division 1, il transmet placement, jeu au pied et mentalité de dernier rempart." },
      ],
    },
  ...
  nl: {
    ...
    coaches: {
      ...
      title1: "Coaches,",
      title2: "met een bewezen parcours.",
      imageLabel: "Training geleid door onze staf",
      list: [
        { initials: "YJ", name: "Y. Janssens", role: "Hoofdtrainer", text: "Meer dan 15 jaar ervaring in de jeugdopleiding. Ex-coach bij een Belgische profacademie, specialist in technische ontwikkeling U17-U23." },
        { initials: "KD", name: "K. De Smet", role: "Fysiek Trainer", text: "Afgestudeerd in de sportwetenschappen, bouwt complete atleten: snelheid, explosiviteit, uithouding en blessurepreventie." },
        { initials: "MD", name: "M. Dupont", role: "Keeperstrainer", text: "Voormalig keeper in eerste divisie, geeft positionering, voetspel en de mentaliteit van de laatste verdediger door." },
      ],
    },
  ...
  en: {
    ...
    coaches: {
      ...
      title1: "Coaches,",
      title2: "with a proven track record.",
      imageLabel: "Session led by our staff",
      list: [
        { initials: "YJ", name: "Y. Janssens", role: "Head Coach", text: "Over 15 years of youth development experience. Former coach at a Belgian professional academy, specialist in U17-U23 technical development." },
        { initials: "KD", name: "K. De Smet", role: "Fitness Coach", text: "Graduate in sports science, building complete athletes: speed, explosiveness, endurance and injury prevention." },
        { initials: "MD", name: "M. Dupont", role: "Goalkeeper Coach", text: "Former first-division goalkeeper, passing on positioning, footwork and the mentality of the last line of defence." },
      ],
    },
