...
export const translations = {
  fr: {
    ...
    contact: {
      ...
      locationLabel: "Notre terrain",
      locationName: "Terrain de football Saint-Nicolas",
      locationCity: "Saint-Nicolas, Liège — Belgique",
  ...
  nl: {
    ...
    contact: {
      ...
      emailLabel: "E-mail",
      phoneLabel: "Telefoon",
      locationLabel: "Ons terrein",
      locationName: "Voetbalterrein Saint-Nicolas",
      locationCity: "Saint-Nicolas, Luik — België",
      mapsCta: "Openen in Google Maps",
    },
  ...
  en: {
    ...
    contact: {
      ...
      emailLabel: "Email",
      phoneLabel: "Phone",
      locationLabel: "Our ground",
      locationName: "Saint-Nicolas football ground",
      locationCity: "Saint-Nicolas, Liège — Belgium",
